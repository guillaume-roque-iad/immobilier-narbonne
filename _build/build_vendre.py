...
<section class="services" id="etapes">
  ...
  <div class="svgrid">
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-bars"/></svg></div><h3>1. Estimation</h3><p>Une estimation gratuite et argumentée de votre bien, fondée sur les ventes réelles constatées à Narbonne, pas sur un algorithme en ligne.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-duo"/></svg></div><h3>2. Préparation du bien</h3><p>Conseils concrets pour présenter votre bien sous son meilleur jour : rangement, petites réparations, mise en valeur des atouts.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-arrow"/></svg></div><h3>3. Diffusion de l'annonce</h3><p>Photos, description et diffusion de votre annonce sur les portails immobiliers et le réseau iad France pour toucher les acquéreurs sérieux.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-focus"/></svg></div><h3>4. Qualification des acquéreurs</h3><p>Chaque demande de visite est qualifiée en amont : budget, financement, projet, pour ne vous faire visiter qu'à des acquéreurs sérieux.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-check"/></svg></div><h3>5. Visites</h3><p>Organisation et accompagnement des visites, avec un retour transparent après chaque rendez-vous.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-people"/></svg></div><h3>6. Négociation</h3><p>Négociation du prix et des conditions de vente dans votre intérêt, avec une position claire sur la valeur réelle de votre bien.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-plus"/></svg></div><h3>7. Compromis de vente</h3><p>Constitution du dossier, coordination avec le notaire et rédaction du compromis de vente dans les règles.</p></div>
    <div class="svcard"><div class="svicon"><svg class="iad-brand-icon" viewBox="0 0 64 48" aria-hidden="true" focusable="false"><use href="/icons.svg?v=20260914#iad-chevron"/></svg></div><h3>8. Signature</h3><p>Suivi du dossier jusqu'à la signature de l'acte authentique chez le notaire, et remise des clés.</p></div>
  </div>
</section>
